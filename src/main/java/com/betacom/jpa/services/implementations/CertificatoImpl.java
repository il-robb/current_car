...
public class CertificatoImpl implements ICertificatoServices{
	...
	public void create(CertificatoReq req) throws AcademyException {
		...
		Optional<Certificato> cerp = certR.findById(req.getId());
		if (cerp.isPresent())
			throw new AcademyException("certificato gia esistente :" + req.getId());
